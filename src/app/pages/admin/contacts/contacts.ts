      ...
      >
        <div class="grid grid-cols-2 gap-4 pt-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input pInputText id="name" [(ngModel)]="contactForm().name" />
          </div>

          <!-- Phone Number -->
          <div class="flex flex-col gap-2">
            <label for="phone" class="font-medium">Phone Number</label>
            <input pInputText id="phone" [(ngModel)]="contactForm().phone" />
          </div>
          ...
          <div class="flex flex-col gap-2">
            ...
            <input pInputText id="gstin" [(ngModel)]="contactForm().gstin" />
          </div>

          <!-- Primary Address -->
          <div class="flex flex-col gap-2 col-span-2">
            <label for="address1" class="font-medium">Primary Address</label>
            <textarea pTextarea id="address1" [(ngModel)]="contactForm().address1" rows="3"></textarea>
          </div>

          <!-- Secondary Address -->
          <div class="flex flex-col gap-2 col-span-2">
            <label for="address2" class="font-medium">Secondary Address</label>
            <textarea pTextarea id="address2" [(ngModel)]="contactForm().address2" rows="3"></textarea>
          </div>
        </div>
